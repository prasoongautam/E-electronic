                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page"> Add coupon</li>
                    ...
                    <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                ...
                                <div class=" widget-block">
                                    ...
                                    <form action="<?= base_url('admin/coupon/add')?>" method="post" enctype="multipart/form-data">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Coupon</label>
                                         ...
                                         <input type="text" name="coupon" value="<?= set_value('coupon')?>" class="form-control"  required="">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Minimum Purchase</label>
                                         ...
                                         <input type="text" name="minimumpurchase" value="<?= set_value('minimumpurchase')?>" class="form-control"  required="">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Offer from</label>
                                         ...
                                         <input type="date" name="offer_from" value="<?= set_value('offer_from')?>" class="form-control"  required="">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Offer To</label>
                                         ...
                                         <input type="date" name="offer_to" value="<?= set_value('offer_to')?>" class="form-control"  required="">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Offer</label>
                                         ...
                                         <input type="number" value="<?= set_value('offer')?>" name="offer" class="form-control" >
