                            ...
                            <div class="page-breadcrumb-wrap">
                                <div class="page-breadcrumb-info">
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page"> Add faq</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                <div class=" widget-block">
                                    <form action="<?= base_url('admin/faq/add')?>" method="post" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label>Question</label>
                                         <input type="text" name="question" value="<?= set_value('question')?>" class="form-control"  required="">
                                     </div>

                                      <div class="form-group">
                                        <label>Answer</label>
                                         <textarea name="answer" class="form-control full-editor"  required=""><?= set_value('answer')?></textarea>
                                     </div>
