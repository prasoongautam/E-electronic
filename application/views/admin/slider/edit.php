                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <label>Sort Order</label>
                                         ...
                                         <input type="number" value="<?= $slider['sort']?>" name="sort" class="form-control" >
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label> Status</label>
                                         ...
                                         <select class="form-control" name="status">
                                             ...
                                             <option <?php if($slider['status']=='Active'){ echo 'selected'; }?>>Active</option>

                                             <option <?php if($slider['status']=='Inactive'){ echo 'selected'; }?>>Inactive</option>
